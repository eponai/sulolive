...
cat Dockerrun2.aws.json.template | sed "s,<ASSET_VERSION>,$ASSET_VERSION," | sed  "s,<DOCKER_IMAGE>,$DOCKER_IMAGE," | sed  "s,<DATADOG_API_KEY>,$DATADOG_API_KEY," | sed  "s,<FIREBASE_SERVICE_ACCOUNT>,$FIREBASE_SERVICE_ACCOUNT," > $DOCKERRUN_FILE
